/**
 * UI Dashboard Styles Module
 * ===========================
 *
 * Extracted from ui-manager.js monolith refactor (Task 1.2/8)
 *
 * Pure module that provides all CSS styles for the REPLOID dashboard.
 * Includes:
 * - CSS variables and theme system (dark/light themes)
 * - Dashboard layout and grid system
 * - Panel component styles
 * - Performance, introspection, reflections, testing panels
 * - Mobile responsive breakpoints
 * - Accessibility focus indicators
 * - Utility classes (animations, buttons, badges, cards)
 * - Visualizer styles (agent, AST)
 * - Diff viewer with syntax highlighting
 * - Python REPL and Local LLM panel styles
 * - Toggle switches and collapsible sections
 */

const UIDashboardStyles = {
    metadata: {
        id: 'UIDashboardStyles',
        version: '1.0.0',
        description: 'Dashboard CSS styles for REPLOID UI',
        dependencies: [],
        async: false,
        type: 'pure',
        tags: ['ui', 'styles', 'css', 'theme']
    },
...
#dashboard {
    ...
    grid-template-areas:
        ...
        "sentinel tools tools"
        "devtools1 devtools2 devtools3"
...
#agent-progress-tracker { grid-area: progress; }
#sentinel-panel { grid-area: sentinel; }
.panel-container { grid-area: tools; display: flex; gap: var(--space-md); }
.panel-container > .panel { flex: 1; min-width: 0; }
#visual-preview-panel { grid-area: preview; }
#advanced-log-panel { grid-area: panels; }

/* Developer tool sections in single row */
.panel-section:nth-of-type(1) { grid-area: devtools1; }
.panel-section:nth-of-type(2) { grid-area: devtools2; }
.panel-section:nth-of-type(3) { grid-area: devtools3; }

/* All other panels occupy the panels area */
#advanced-log-panel,
#performance-panel,
#introspection-panel,
#python-panel,
...
`;
        ...
        return {
             ...
             * @returns {string} Complete dashboard CSS
             */
            getStyles: () => UI_CORE_CSS,
...
if (typeof module !== 'undefined' && module.exports) {
    module.exports = UIDashboardStyles;
}

// Return for Function() constructor evaluation (browser)
UIDashboardStyles;
