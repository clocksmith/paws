 ...
 */
function validateSections(manifest: Manifest): boolean {
 ...
 */
function assembleSections(manifest: Manifest, outputFile: string): number {
 ...
 */
function assembleProtocol(options: Options): number {
