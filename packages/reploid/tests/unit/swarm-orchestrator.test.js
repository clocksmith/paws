...
import SwarmOrchestrator from '../../upgrades/swarm-orchestrator.js';
describe('SwarmOrchestrator Module', () => {
  ...
  beforeEach(() => {
    ...
    orchestrator = SwarmOrchestrator.factory(mockDeps);
  });
  ...
  describe('Task Delegation', () => {
    ...
    it('should fail when not initialized', async () => {
      ...
      const uninit = SwarmOrchestrator.factory(mockDeps);
