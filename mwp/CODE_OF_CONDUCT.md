...
* Ignoring or dismissing feedback from community members
...
* A description of the behavior and the incident
...
* Through GitHub's reporting features
* Via direct message to project maintainers on Discord
...
In addition to behavioral standards, we expect contributors to:
...
* Provide sufficient context and reproduction steps for bugs
* Update issues and PRs when new information becomes available
* Follow up on your contributions in a timely manner
...
* Respect the project's direction and maintainers' decisions
...
1. Sending a detailed explanation to the project maintainers
2. Providing any relevant context or evidence
3. Explaining why you believe the enforcement action was inappropriate
...
We appreciate your help in making this a welcoming, friendly community for all.
