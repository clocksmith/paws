/**
 * MCP Widget Protocol (MWP) - Alloy Specification
 *
 * This specification models the MCP Widget Protocol and verifies that:
 ...
 *   4. MWP refines MCP (every MWP operation is a valid MCP operation)
 *
 * Author: PAWS Team
 * Date: 2025-10-21
 * MWP Version: 1.0.0
